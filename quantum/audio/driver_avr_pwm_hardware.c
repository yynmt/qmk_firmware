...
/*
  ...
  drive up to two speakers through the AVR PWM hardware-peripheral, using timer1 and/or timer3 on Atmega32U4, using timer1 on Atmega32U2.
  ...
  > channel_1(timer3): PC4, PC5, PC6
  > channel_2(timer1): PB5, PB6, PB7

  Atmega32u2:
  the channel_1 can be connected to either pin PC5 PC6 or PB7 with a PWM signal generated by timer1
  secondary speaker cannot be used
  > channel_1(timer1): PB7, PC5, PC6
*/

#if defined(__AVR_ATmega32U2__)
#    if defined(AUDIO_PIN) && (AUDIO_PIN != C6) && (AUDIO_PIN != C5) && (AUDIO_PIN != B7)
...
#        error "Audio feature: ATmega32U2 can not use AUDIO_PIN_ALT."
#    endif

#    if (AUDIO_PIN == C6) || (AUDIO_PIN == C5) || (AUDIO_PIN == B7)
